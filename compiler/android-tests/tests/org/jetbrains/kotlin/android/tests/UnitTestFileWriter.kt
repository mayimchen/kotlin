...
class UnitTestFileWriter(private val fileName: String, private val index: Int, private val prefix: String, private val generatedTestNames: MutableSet<String>) {
    ...
    fun generate() {
        FileWriter(File(fileName).also { it.parentFile.mkdirs() }).use { suite ->
            ...
            p.println(
                ...
                |public class ${CodegenTestsOnAndroidGenerator.testClassName}$prefix$index extends ${CodegenTestsOnAndroidGenerator.baseTestClassName} {
                |
            """.trimMargin()
            )
            p.pushIndent()
